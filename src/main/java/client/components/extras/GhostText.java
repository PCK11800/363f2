package client.components.extras;
        ...
        implements FocusListener, DocumentListener
{
    ...
    public GhostText(JTextComponent component, String text)
    {
        this(component, text, Show.ALWAYS);
    }

    public GhostText(JTextComponent component, String text, Show show)
    {
