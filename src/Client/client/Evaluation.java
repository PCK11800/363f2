...
public class Evaluation {
    ...
    public boolean checkPasswordStrength(String password)
    {
        if(lengthOK(password) // check if password is of appropriate length
               ...
               ) // check if password doesn't contain any real words (English dictionary word list .txt file is from: http://www.gwicks.net/dictionaries.htm)
    ...
    public static boolean lengthOK(String password)
    {
        ...
        System.out.println("PASSWORD FAILED LENGTH");
        return false;
    }
    ...
    public static boolean containsDigits(String password)
    {
        ...
        System.out.println("PASSWORD FAILED NUMBER");
        return false;
    }
    ...
    public static boolean containsLowercase(String password)
    {
        ...
        System.out.println("PASSWORD FAILED lower");
    ...
    public static boolean containsUppercase(String password)
    {
        ...
        System.out.println("PASSWORD FAILED UPPER");
    ...
    public static boolean containsSpecialCharacter(String password)
    {
        ...
        System.out.println("PASSWORD FAILED SPECIAL");
